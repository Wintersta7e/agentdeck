...
function makeRoutingMock(overrides?: {
  ...
  const home = overrides?.home ?? '/home/user'
  const findResult =
    overrides?.findResult ?? '/home/user/.claude/projects/test/sessions/abc.jsonl\n'
  const headResult = overrides?.headResult ?? '{"cwd":"/home/user/project"}\n'
...
describe('file discovery', () => {
  ...
  it('skips files already bound to another session', async () => {
    const file = '/home/user/.claude/projects/test/sessions/abc.jsonl'
