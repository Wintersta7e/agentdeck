...
export const CH = {
  ...
  agentsDeleteCustom: 'agents:deleteCustom',
  agentsGetCustomSpec: 'agents:getCustomSpec',
  ...
  agentsGetRegistry: 'agents:getRegistry',
  agentsGetVisible: 'agents:getVisible',
  agentsParseError: 'agents:parseError',
  agentsRegistryChange: 'agents:registryChange',
  agentsSaveCustom: 'agents:saveCustom',
